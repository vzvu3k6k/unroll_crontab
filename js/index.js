...
var Task = React.createClass({displayName: "Task",
  render: function() {
    ...
    return React.createElement("li", null, 
      React.createElement("time", {dateTime: this.props.time.toISOString()}, date2str(this.props.time)), 
      React.createElement("code", null, this.props.command)
      );
  },
});

var UnrollCrontabConfig = React.createClass({displayName: "UnrollCrontabConfig",
  ...
  render: function() {
    return React.createElement("form", {className: "unrollCrontabConfig"}, 
      React.createElement("label", {htmlFor: "unrollCrontabConfig-date"}, "Start"), 
      React.createElement("input", {type: "text", name: "start", id: "unrollCrontabConfig-date", value: this.state.startValueOnEdit || this.startDateToString(this.props.startDate), ref: "start", onChange: this.onChange}), 
      React.createElement("input", {type: "button", onClick: this.onClickNow, value: "Now"})
      );
  },
...
var UnrollCrontab = React.createClass({displayName: "UnrollCrontab",
  update: function() {
  ...
  render: function() {
    ...
    for (var i = 0; i < 10; i++) {
      ...
      taskNodes.push(React.createElement(Task, {time: item.value.next, command: item.value.command, key: key}));
    }
    return React.createElement("div", {className: "unrollCrontab"}, 
      React.createElement("textarea", {className: "crontab", ref: "crontab", onChange: this.update, placeholder: "Paste your `crontab -l`"}), 
      React.createElement(UnrollCrontabConfig, {updateStartDate: this.updateStartDate, startDate: this.state.startDate}), 
      React.createElement("ol", {className: "unrolledTasks"}, 
        taskNodes
      )
      );
  },
...
React.render(React.createElement(UnrollCrontab, null), document.querySelector('div'));


},{"./lib/parse":2,"./lib/unroll_crontab":3,"react":163}],2:[function(require,module,exports){
...
},{"cron-parser":8}],3:[function(require,module,exports){
...
},{"./expression":7,"fs":4}],9:[function(require,module,exports){
/**
